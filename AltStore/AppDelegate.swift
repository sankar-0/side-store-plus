...
//        UserDefaults.standard.setValue(true, forKey: "com.apple.CoreData.SQLDebug")
        ...
        // Register BGTaskScheduler tasks for multi-account background auto-refresh
        RefreshManager.shared.registerBackgroundTasks()
        RefreshManager.shared.scheduleAppRefresh()
    ...
    {
        // Schedule next background refresh with BGTaskScheduler
        RefreshManager.shared.scheduleAppRefresh()
    ...
    {
        // Auto-connect embedded WireGuard VPN loopback tunnel on application activation
        VPNManager.shared.autoConnectIfEnabled()
