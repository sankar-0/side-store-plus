...
public extension UserDefaults
{
    ...
    @objc var isAutoVPNEnabled: Bool {
        get { (self.object(forKey: #function) as? Bool) ?? true }
        set { self.set(newValue, forKey: #function) }
    }
    
    @objc var isAutoDisconnectVPNOnBackgroundEnabled: Bool {
        get { (self.object(forKey: #function) as? Bool) ?? false }
        set { self.set(newValue, forKey: #function) }
    }
    ...
    class func registerDefaults()
    {
        ...
        let defaults = [
            ...
            #keyPath(UserDefaults.isAutoVPNEnabled): true,
            #keyPath(UserDefaults.isAutoDisconnectVPNOnBackgroundEnabled): false,
