...
final class SceneDelegate: UIResponder, UIWindowSceneDelegate
{
    ...
    func sceneDidBecomeActive(_ scene: UIScene)
    {
        ...
        // Auto-connect embedded WireGuard VPN loopback tunnel on foreground activation
    ...
    func sceneDidEnterBackground(_ scene: UIScene)
    {
        ...
        // Auto-disconnect VPN tunnel on background if user enabled this preference
        VPNManager.shared.autoDisconnectIfEnabled()
