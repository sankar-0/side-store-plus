        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    NavigationLink(destination: MultiAccountView()) {
                        HStack {
                            VStack(alignment: .leading, spacing: 2) {
                                Text("Multi-Account Pool")
                                    .font(.system(size: 17, weight: .bold))
                                    .foregroundColor(.white)
                                Text("\(MultiAccountManager.shared.activeAccountsCount) Accounts • \(MultiAccountManager.shared.totalUsableAppSlots) Usable Slots")
                                    .font(.system(size: 12))
                                    .foregroundColor(Color.white.opacity(0.6))
                            }
                            Spacer()
